                    ...
                    open: function(opts) {
                        ...
                        $q.all({
                            ...
                            $dialog.html((options.overlay ?
                                '<div class="ngdialog-overlay"></div><div class="ngdialog-share-content" role="document">' + template + '</div>' :
                                '<div class="ngdialog-content" role="document">' + template + '</div>'));
                            /*        $dialog.html(('<div class="ngdialog-overlay"></div><div class="ngdialog-share-content" role="document">' + template + '</div>'));
                             */
